export const roomList = [
  ...
  },
  {
    ...
    description: "A beachfront resort with stunning sunset views",
    ...
    reviews: [
      {
        author: "Linda",
        comment: "Breathtaking views and excellent amenities",
      },
      { author: "Michael", comment: "Friendly staff and great food" },
    ],
    imageLocation: "https://picsum.photos/200/300?3",
    ...
    website: "https://www.sunsetbeach.com",
    checkInTime: "16:00",
    checkOutTime: "11:00",
    nearbyAttractions: ["Snorkeling spots", "Boat tours", "Local markets"],
    roomsAvailable: [
      { type: "Standard", price: 300, quantity: 6 },
      { type: "Villa", price: 500, quantity: 4 },
    ],
    featured: true,
  },
];
